...
public class SignalServiceImpl implements SignalService {
    ...
    public Mono<Signal> pushSignal(String organizationId, SignalRequest signalRequest) {
        return eServiceRepository.findByOrganizationIdAndEServiceId(organizationId, signalRequest.getEserviceId())
                .switchIfEmpty(Mono.error(new PocGenericException(ExceptionTypeEnum.CORRESPONDENCE_NOT_FOUND, ExceptionTypeEnum.CORRESPONDENCE_NOT_FOUND.getMessage().concat(signalRequest.getEserviceId()), HttpStatus.FORBIDDEN)))
                ...
                .flatMap(eservice -> {
                    ...
                    return Mono.error(new PocGenericException(ExceptionTypeEnum.SIGNALID_ALREADY_EXISTS, ExceptionTypeEnum.SIGNALID_ALREADY_EXISTS.getMessage().concat(signalRequest.getEserviceId()), HttpStatus.FORBIDDEN));
